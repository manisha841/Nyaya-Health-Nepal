'''
Question 3: The NumPy (Numeric Python) package helps us manipulate large arrays and
...
def solution(given_input: list):
  reversed_list = given_input[::-1]
  result = np.array(reversed_list, float)
  return result
